  ...
  const seatCategories = [
    {
      ...
      rows: ["A", "B"],
      price: 300,
      img: "/assets/seats/blue-seat.png",
    },
    {
      type: "Gold",
      rows: ["C", "E"],
      price: 200,
      img: "/assets/seats/red-seat.png",
    },
    {
      type: "Silver",
      rows: ["D", "F"],
    ...
    <div className="seat-selection-page container mt-5">
      ...
      <div className="d-flex justify-content-center gap-3 flex-wrap mb-3">
        ...
        <select
          ...
          style={{
            ...
            backgroundColor: "#bcddf4ff", // background
            WebkitAppearance: "none", // remove default mobile style
      ...
      {seatCategories.map((category) => (
        <div key={category.type} className="mb-4">
          <h6>
            {category.type} Seats (₹{category.price})
          </h6>
